...
<section>
    <div class="container_admin">
        ...
        <table id="user_order_list" cellspacing="0">
            ...
            <?php foreach ($orders as $order) :
                ...
                <tr>
                    ...
                    <td>
                        <?php foreach ($products as $product): ?>
                            ...
                            echo '<span>Цена: </span>' . $product['price']; echo ' бел.руб.';
                            echo "</br>";
                            ?>
                            <?php
                ...
                <tr class="total_price">
                    <td colspan="4"><?php echo '<span>Сумма заказа: ' . $totalValue; echo' бул.руб.</span>';?></td>
                </tr>
                <?php
                    //Очищаем массив
                    $arr = array();
       ...
       <a href="/cabinet" id="reg_main_a"> В кабинет</a>
    </div>
</section>
