    ...
    <div class="container">
        ...
        <div class="content">
            <div class="features_items">
                <h2>Товары выбранной категории</h2>
                <!--single item-->
                <?php foreach($categoryProduct as $categoryProducts):?>
                    <div class="item">
                        ...
                        <p class="item_price"><?php echo $categoryProducts['price']?>&nbspбел.руб.</p>
                        <a target="_blank" href="/product/<?php echo $categoryProducts['id']?>">
                            <p class="item_name"><?php echo $categoryProducts['name']?></p>
                        </a>
                        <a href="#" class="glow-button" data-id="<?php echo $categoryProducts['id'];?>">
                            В корзину
                        </a>
                    </div>
                <?php endforeach;?>
